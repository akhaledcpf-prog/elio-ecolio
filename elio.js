...
const HTML=`<div id="elio-tip" onclick="eT()">👋 Bonjour ! Je suis <span>Élio</span>. Vous pensez à l'énergie renouvelable pour votre logement ? Je réponds maintenant — et je calcule vos économies en prime.</div><button id="ef"><img id="ef-i" src="https://helpful-beijinho-24b6c1.netlify.app/elio-idle.jpg" alt="Élio"/><img id="ef-t" src="https://helpful-beijinho-24b6c1.netlify.app/elio-thinking.jpg" alt="" style="opacity:0"/><img id="ef-s" src="https://helpful-beijinho-24b6c1.netlify.app/elio-smile.jpg" alt="" style="opacity:0"/><span id="eb">1</span></button><div id="ec"><div id="eh"><div id="ea"><img id="ea-i" src="https://helpful-beijinho-24b6c1.netlify.app/elio-idle.jpg" alt="Élio"/><img id="ea-t" src="https://helpful-beijinho-24b6c1.netlify.app/elio-thinking.jpg" alt="" style="opacity:0"/><img id="ea-s" src="https://helpful-beijinho-24b6c1.netlify.app/elio-smile.jpg" alt="" style="opacity:0"/></div><div><div id="en">Élio · Ecolio Energy</div><div id="es"><span id="eo"></span>Expert IA · Ecolio Energy</div></div><button id="ex">&#x2715;</button></div><div id="em"></div><div id="esg" style="display:none"></div><div id="eiw"><textarea id="ei" placeholder="Votre question..." rows="1"></textarea><button id="ebt"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="22" y1="2" x2="11" y2="13"/><polygon points="22 2 15 22 11 13 2 9 22 2"/></svg></button></div><div id="eft">Élio · Commercial IA Ecolio Energy</div></div>`;
...
async function eBrev(d){
  ...
  try{
    await fetch('https://api.brevo.com/v3/contacts',{
      ...
      body:JSON.stringify({
        email:d.email||('noemail_'+Date.now()+'@elio.ecolio.fr'),
        attributes:{FIRSTNAME:d.name||'',SMS:d.phone||'',PROJET:d.project||'',DEPT:d.dept||'',SOURCE:'Elio IA'},
        listIds:[CFG.brevoList],
        updateEnabled:true
      })
    });
  }catch(e){}
